...
// tableEl.insertAdjacentHTML("beforeend", createTableMarkup(transactionHistory));

function renderTableMarkup(data, selector = "", position = "beforeend") {
  ...
  elem.insertAdjacentHTML(position, markup);
}

renderTableMarkup(transactionHistory, ".js-transaction-table");

// const tableMarkup = transactionHistory
//   .map(item => {
//     return `<tr>
//       <td>${item.id}</td>
//       <td>$${item.amount}</td>
...
// tableEl.insertAdjacentHTML("beforeend", tableMarkup);
